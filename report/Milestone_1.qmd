...
Treatment: The treatment group comprises of households living within a set distance of the landfill. This group would be exposed to the effects of landfill proximity, influencing the wealth variable. Buffer distance to landfill is different in every one (varying landfill buffer sizes):

Kenya -

-   Dandora: 22,000 feet (equivalent to 6,705.6 meters)

-   Kibera: 18,500 feet (5,638.8 meters)

-   Maweni: 10,000 feet (3,048 meters)

Ghana -

-   Agbogbloshie: 15,000 feet (4,572 meters)

-   Oti: 20,000 feet (6,096 meters)

Controls: The control group consists of households within a set distance of the city center, which would not be exposed to landfill effects. This allows us to compare the treatment group's wealth to the control group's. Distance to city center is different in every landfill (consistent city center buffer size + varying ring size):

Kenya -

-   Dandora: 10,000 feet + 6,000 feet = 16,000 feet (4,876.8 meters)

-   Kibera: 10,000 feet + 2,000 feet = 12,000 feet (3,657.6 meters)

-   Maweni: 10,000 feet + 10,000 feet = 20,000 feet (6,096 meters)

Ghana -

-   Agbogbloshie: 10,000 feet + 8,000 feet = 18,000 feet (5,486.4 meters)

-   Oti: 10,000 feet + 6,000 feet = 16,000 feet (4,876.8 meters)
...
To address this variation, we will employ a Ordinary Least Squares (OLS) fixed effects model. Specifically, a two- way fixed effects model as it will help us control for unobserved heterogeneity across both household groups and time (2008 and 2014). Then, it will be possible to account for time invariant characteristics of the households as well as shocks or any trends that could affect wealth index. This method helps to isolate the impact of landfill proximity on households wealth from other confounding factors, and thus improve comparability between the two groups. Some assumptions of this method include parallel trends, where both groups would follow parallel paths over times in terms of their wealth. Also, that there should be no spillover effects, so treatment effect does not impact directly or indirectly the wealth index in the control group. With the literature research done, we assume that households closer to the landfill (treatment group) will have a higher wealth index compared to households further away from the landfill (control group).
